    ...
    <div class="modal">
      ...
      <div v-if="step === 1" class="step-content">
        ...
        <div class="platform-list">
          <label
            v-for="(_enabled, platform) in platforms"
            :key="platform"
            class="platform-option"
            :class="{ disabled: platformStatus[platform] === 'coming soon' }"
          >
            <input
              type="checkbox"
      ...
      <div v-if="step === 2" class="step-content">
        ...
        <div class="text-editor">
          <textarea v-model="platformTexts[activePlatformTab]" class="platform-textarea" rows="6" />
          <div
            class="char-count"
            :class="{ over: (platformTexts[activePlatformTab] || '').length > CHAR_LIMITS[activePlatformTab] }"
          >
        ...
        <div class="review-list">
          <div v-for="p in selectedPlatforms" :key="p" class="review-card">
            ...
            <div class="review-text">
              {{ (platformTexts[p] || '').slice(0, 120) }}{{ (platformTexts[p] || '').length > 120 ? '...' : '' }}
            </div>
          </div>
        </div>
      </div>
